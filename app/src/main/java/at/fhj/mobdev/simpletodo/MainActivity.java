...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private void loadData() {
        // TODO Load your data here. If done, call setLoadedItems() with your list of Todo elements
    List<Todo> todos = new ArrayList<Todo>();
        ...
        while (cursor.moveToNext()) {
            ...
            int d1 = cursor.getInt(cursor.getColumnIndex("id"));
            String d2 = cursor.getString(cursor.getColumnIndex("title"));
            String d3 = cursor.getString(cursor.getColumnIndex("description"));
            Todo todo = new Todo(d2,d3);
            todo.setId(d1);
            todos.add(todo);
        }
